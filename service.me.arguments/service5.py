...
def getsettings():
    global message, checkfolder, monitorfolder, monitorfile, idletime, freq, loglevel, addonlog, notify, scriptfolderset, scriptfolder, centralfolder, centralfolderset, nocentral, centralidletime, centraldelay, centralfreq
    # set defaults
