...
def getsettings():
    global message, checkfolder, monitorfolder, idletime, freq, loglevel, addonlog, notify, scriptfolderset, scriptfolder, centralfolder, centralfolderset, nocentral, centralidletime, centraldelay, centralfreq, archivenumber, archiveall
    # set defaults
