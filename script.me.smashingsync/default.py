...
def getversion():
    ...
    if xbmcvfs.exists(textfile):
        versionfile = xbmcvfs.File(textfile)
...
def checkforupdatedaddon():
    ...
    print ('currentfolder is %s'% currentfolder)
    ...
    print ('smashingfolder is %s'% smashingfolder)
    ...
    if not ADVANCEDSMASHINGCHECKED == 'false':
        ...
        print ('advancedfolder is %s'% advancedfolder)
        print ('advancedversion is %s'% advancedversion)
    ...
    if not size == 0:
        ...
        while c < size:
            ...
            if c == 0:
                print ('First default folder is %s'% addonfolder)
            else:
                print ('Next default folder is %s'% addonfolder)
    ...
    if not smashingsource == ADVANCEDSMASHINGCHECKED:
        if not smashingsource in DEFAULTPATHS:
            ...
            print ('selectedversion is %s'% selectedversion)
